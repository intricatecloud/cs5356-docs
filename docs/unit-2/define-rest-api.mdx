...
In this section, we're going to define the set of API Routes / Endpoints / URLs that we need to build for our application, based on the data model and the functions we put together in [Work with Data in Javascript](./js-and-data).
