...
For this exercise, you'll take the data model that you worked on in [Exercise: Define the Data Model](./exercise-define-data-model) and the functions you wrote in [Exercise: Work with Data in JS](./exercise-work-with-data.mdx) and you'll define the set of APIs for your application
