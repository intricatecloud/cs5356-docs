...
__Step 2:__ Go to the [Firebase Console](https://console.firebase.google.com/u/0/), and create a new project vi. __Don't__ reuse your Milestone 1 project.
...
`npx firebase init hosting` and follow the prompts.
