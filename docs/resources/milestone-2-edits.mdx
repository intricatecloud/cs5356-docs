...
There are a couple of instances where I mistakenly included one thing in the API description, and wrote a different expectation in the unit test. You can view some of those corrections in this PR diff
