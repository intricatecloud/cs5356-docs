...
## After I deploy, sometimes my data is there, sometimes its not.

You might notice funny behavior once you deploy your site to Firebase, where sometimes your data is there and sometimes it's not. Sometimes this is due to bugs in your code, and other times, this is due to the way Firebase hosts your code - we'll talk about this in class a little bit.

In any case, because of that issue, I'll be running your apps locally and grading based on how your app behaves on localhost - if the Firebase URL isn't behaving correctly.

So if your deployed Firebase app sometimes works, and sometimes doesn't, don't fret! Submit what you have!
